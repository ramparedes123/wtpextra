    ...
    <>
      ...
      <Modal size="lg" show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Basic Activity Information</Modal.Title>
        </Modal.Header>
        <Modal.Body>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  ...
                  >
                    ...
                    <option value="Hotel">Fishing</option>
                    <option value="Condominium">Back Packing</option>
                    <option value="Trench House">Canyoning</option>
                    <option value="Trench House">Camping</option>
                  </select>
                </div>
              </div>
